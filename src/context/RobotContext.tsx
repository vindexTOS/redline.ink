...
type Cell = {
  ...
  setIsRobotActive: React.Dispatch<React.SetStateAction<boolean>>;
};
...
export const RobotContextProvider = ({
  ...
  const RobotPromps = {
    hello:
      " გამარჯობა, კეთილი იყოს თქვენი მობრძანება Redline Technologies".split(
        " "
      ),
    iWilLHelP: "დააკლიკე სტარტ ღილაკს და დაგეხმარები :)".split(" "),
    services:
      "ძაალიან კარგი შემოთავაზებები და სერვისები აქვთ, ბოლო-ბოლო მე გამაკეთეს :)".split(
        " "
      ),
    team: "ნახეთ რა ვაჟკაცები გვყავს გუნდში, დათვებივით ბიჭებიი".split(" "),
    project:
      "თუ გინდა რომ შენი პროექტიც მოხვდეს აქ დაგვიკავშირდით: info@redline.ink ".split(
        " "
      ),
    contact:
      "დაგვიკავშირდით info@redline.ink  ან მოგვწერეთ facebook-ზე ლინკი ქვემოთ არის O_o".split(
        " "
      ),
  };
