...
function RobotNav() {
	...
	return (
		<div className={`text-white flex relative z-50 ${!robotState.closeNav && 'hidden'}`}>
			<nav className="flex  flex-col font-geo">
				...
				<div className="flex  flex-col  text-yellow-500 text-start p-3 gap-1">
					...
					<a onClick={() => scrollToSection(projectRef)} className={style.a}>
						<GoProjectRoadmap /> პროექტები
					</a>
					<a onClick={() => scrollToSection(contactRef)} className={style.a}>
